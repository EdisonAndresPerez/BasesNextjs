...
export const Sidebar = () => {
  return (
    <div
      id="menu"
      className="bg-gray-900 min-h-screen z-10 text-slate-300 w-[400]  left-0 h-screen "
    >
      ...
      <div id="profile" className="px-6 py-10">
        ...
        <a href="#" className="inline-flex space-x-2 items-center">
          ...
          <span className="text-sm md:text-base font-bold">Edison Andres Perez Martinez</span>
        </a>
      </div>
